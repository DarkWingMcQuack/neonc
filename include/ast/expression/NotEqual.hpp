...
class NotEqual : public AreaBase
{
public:
    constexpr NotEqual(lexing::TextArea area, Expression&& lhs, Expression&& rhs) noexcept
        : AreaBase(area),
          lhs_(std::move(lhs)),
          rhs_(std::move(rhs)) {}
    ...
    constexpr auto getightSide() noexcept -> Expression&
    {
        return rhs_;
    }
